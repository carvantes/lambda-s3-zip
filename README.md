...
This is a sample template for lambda-s3-zip - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name lambda-s3-zip --query 'Stacks[].Outputs'
```
